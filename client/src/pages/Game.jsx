...
const Game = (props) => {
    // console.log(props);
    // console.log(queryString.parse(props.location));
    ...
    return (
        <div className={`Game backgroundColorR backgroundColor${currentColor}`}>
                ...
                {users.length===2 && <>
                    ...
                    <div>
                        ...
                        <div className='middleInfo' style={turn === 'Player 2' ? {pointerEvents: 'none'} : null}>
                            <button className='game-button' disabled={turn !== 'Player 1'} onClick={onCardDrawnHandler}><img src="../assets/draw-stack.png" className='h-36 w-28'/>DRAW</button>
                            {playedCardsPile && playedCardsPile.length>0 &&
                            <img
                                className='Card'
                                src={`../assets/cards-front/${playedCardsPile[playedCardsPile.length-1]}.png`}
                                /> }
                            <button className='' disabled={player1Deck.length !== 2} onClick={() => {
                                setUnoButtonPressed(!isUnoButtonPressed)
                                playUnoSound()
                            }}><img src="../assets/uno-button.png" className='h-36 w-48'/></button>
                        </div>
                        <br />
                        ...
                        <div className='middleInfo' style={turn === 'Player 1' ? {pointerEvents: 'none'} : null}>
                            <button className='' disabled={turn !== 'Player 2'} onClick={onCardDrawnHandler}><img src="../assets/draw-stack.png" className='h-36 w-28'/>DRAW</button>
                            {playedCardsPile && playedCardsPile.length>0 &&
                            <img
                                className='Card'
                                src={`../assets/cards-front/${playedCardsPile[playedCardsPile.length-1]}.png`}
                                /> }
                            <button className='' disabled={player2Deck.length !== 2} onClick={() => {
                                setUnoButtonPressed(!isUnoButtonPressed)
                                playUnoSound()
                            }}><img src="../assets/uno-button.png" className='h-36 w-48'/></button>
                        </div>
            ...
            <br />
            <a href='/'><button className="game-button red">Surrend</button></a>
        </div>
    )
}
{/* <Outlet/> */}
